...
void CubeRenderer::createVertexBuffer() {
    ...
    std::vector<Vertex> vertices = {
        // 前面（白色，法线指向 +Z）
        {{-2.5f, -2.5f,  2.5f},  {0.0f, 0.0f, 1.0f}, {1.0f, 1.0f, 1.0f}, {0.0f, 0.0f}},
        {{ 2.5f, -2.5f,  2.5f},  {0.0f, 0.0f, 1.0f}, {1.0f, 1.0f, 1.0f}, {1.0f, 0.0f}},
        {{ 2.5f,  2.5f,  2.5f},  {0.0f, 0.0f, 1.0f}, {1.0f, 1.0f, 1.0f}, {1.0f, 1.0f}},
        {{-2.5f,  2.5f,  2.5f},  {0.0f, 0.0f, 1.0f}, {1.0f, 1.0f, 1.0f}, {0.0f, 1.0f}},
        ...
        // 左面（白色，法线指向 -X）
        {{-2.5f, -2.5f, -2.5f},  {-1.0f, 0.0f, 0.0f}, {1.0f, 1.0f, 1.0f}, {0.0f, 0.0f}},
        {{-2.5f, -2.5f,  2.5f},  {-1.0f, 0.0f, 0.0f}, {1.0f, 1.0f, 1.0f}, {1.0f, 0.0f}},
        {{-2.5f,  2.5f,  2.5f},  {-1.0f, 0.0f, 0.0f}, {1.0f, 1.0f, 1.0f}, {1.0f, 1.0f}},
        {{-2.5f,  2.5f, -2.5f},  {-1.0f, 0.0f, 0.0f}, {1.0f, 1.0f, 1.0f}, {0.0f, 1.0f}},
        ...
        // 上面（白色，法线指向 +Y）
        {{-2.5f,  2.5f, -2.5f},  {0.0f, 1.0f, 0.0f}, {1.0f, 1.0f, 1.0f}, {0.0f, 0.0f}},
        {{ 2.5f,  2.5f, -2.5f},  {0.0f, 1.0f, 0.0f}, {1.0f, 1.0f, 1.0f}, {1.0f, 0.0f}},
        {{ 2.5f,  2.5f,  2.5f},  {0.0f, 1.0f, 0.0f}, {1.0f, 1.0f, 1.0f}, {1.0f, 1.0f}},
        {{-2.5f,  2.5f,  2.5f},  {0.0f, 1.0f, 0.0f}, {1.0f, 1.0f, 1.0f}, {0.0f, 1.0f}},
...
void CubeRenderer::render(VkCommandBuffer commandBuffer, VkPipelineLayout pipelineLayout,
    ...
    pushConstants.baseColor = glm::vec3(1.0f);  // 白色
